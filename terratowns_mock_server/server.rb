...
class Home
  ...
  # very similar and in most casses identical validation
...
# we want to lock this down to only be from cloudfront
  validates :domain_name, 
    ...
    # we will make sure it has an incremeb=nt version in the controller.
...
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    # Check if the AUTHORIZATION header  is exists
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # printing the variables out to console to make it easier to 
    # see or debug what we have inputed into this endpoint
    puts "name #{name}"
    ...
    # return the errors 
    unless home.valid?
      # return the erors messages back as json
  ...
  get '/api/u/:user_uuid/homes/:uuid' do
    ...
    content_type :json
    # does the uuid in the home match the one in our mock database
